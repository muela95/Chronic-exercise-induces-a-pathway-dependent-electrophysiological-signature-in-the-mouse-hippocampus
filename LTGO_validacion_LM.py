...
def generate_evaluation_plots(results_summary, importance_df, effect_sizes_df):
    ...
    plt.tight_layout()
    plt.savefig('neural_classifier_evaluation.png', dpi=300, bbox_inches='tight')
    plt.show()
...
def main():
    ...
    data_file = 'D:/Laboratorio/Registros/Experimental-ejercicio/LM8-todo.mat'
    ...
    logger.info(f"- neural_classifier_evaluation.png")
