...
output_file = os.path.join(folder_path, 'LM8-run.mat')
...
"""
row_mapping = {
    'Run1.mat': 1,  # Parece tener estados, desde el ~360 al 680 parece estar mucho más potente LM
    'Run2.mat': 1,  # un poco de theta al principio, nada al final, debería dar igual si solo se coge del centro
    # 'Run3.mat': 0,  # dejo del 15 al 130
    'Run3.mat': 0,
    # 'Run4.mat': 0,
    'Run4.mat': 1, 
    # 'Run5.mat': 2,  # Tiene algo de theta, no muchísimo, pero en todo el archivo, tendría que estar fuera de todo
    'Run5.mat': 3,
    # 'Run6.mat': 6,
    'Run6.mat': 1,
    'run2-mio.mat': 2,
