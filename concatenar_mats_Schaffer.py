...
folder_path = 'D:/Laboratorio/Registros/Experimental-ejercicio/run/'
output_file = os.path.join(folder_path, 'Schff8-run.mat')
...
row_mapping = {
    ...
    'Sed1.mat': 5,  
    'Sed2.mat': 2,  
    # 'Sed3.mat': 0, # Para lacunoso cogí el sed4, pero ese no tiene schaffer, así que cojo ahora sed3 que antes estaba fuera    
    'Sed3.mat': 3,
    #'Sed4.mat': 0,
    'Sed5.mat': 3, 
    'Sed6.mat': 7,
    #'Sed7.mat': 1, Este igual, lo cogía en LM, aquí no tiene schaffer, cojo sed1-mio
    'sed1-mio.mat': 4,
    'sed2-mio.mat': 3, 
    'sed3-mio.mat': 5   
...
"""
row_mapping = {
    # 'Run1.mat': 0,  # Parece tener estados, desde el ~360 al 680 parece estar mucho más potente LM, lo uso para schaffer, a diferencia de LM
    'Run1.mat': 2,
    #'Run2.mat': 0,  # un poco de theta al principio, nada al final, debería dar igual si solo se coge del centro
    'Run2.mat': 2,
    # 'Run3.mat': 0,  # dejo del 15 al 130
    'Run3.mat': 2,
    'Run4.mat': 5, # cogiendo otro set de generadores
    #'Run5.mat': 1,  # Tiene algo de theta, no muchísimo, pero en todo el archivo, tendría que estar fuera de todo
    'Run5.mat': 4,
    # 'Run6.mat': 4,
    'Run6.mat': 2,
    'run2-mio.mat': 1,
    'run6-mio.mat': 3 # Electrodo muy superficial, no sé si debería importar   
