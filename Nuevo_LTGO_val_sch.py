...
def generate_evaluation_plots(results_summary, importance_df, effect_sizes_df):
    ...
    plt.tight_layout()
    plt.savefig('neural_classifier_evaluation_schaffer.png', dpi=300, bbox_inches='tight')
    plt.show()
...
def main():
    ...
    logger.info(f"- neural_classifier_evaluation_schaffer.json")
    logger.info(f"- feature_importance_rankings_schaffer.csv")
    logger.info(f"- effect_size_analysis_schaffer.csv")
    logger.info(f"- neural_classifier_evaluation_schaffer.png")
